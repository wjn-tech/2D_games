...
const STYLE_MAP = {
	...
	"Friendly": {"shape": Shape.RECT, "color": Color(0.9, 0.9, 0.9)},
	"Neutral": {"shape": Shape.CIRCLE, "color": Color(0.9, 0.9, 0.5)}
}
...
func setup_from_npc(npc_data_name: String, alignment: String, _ai_type: int) -> void:
