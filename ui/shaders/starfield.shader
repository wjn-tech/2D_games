...
uniform float star_blink : hint_range(0.0,1.0) = 0.6;
uniform vec4 nebula_color_a : hint_color = vec4(0.28,0.12,0.35,0.6);
uniform vec4 nebula_color_b : hint_color = vec4(0.12,0.05,0.45,0.6);
